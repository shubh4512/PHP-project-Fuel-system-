...
<html>
    ...
    <div class="header">
        ...
        <h1 class="heading">Fuel Sale Entry</h1><br>
        <div class="dgrid">    
...
if(isset($_POST['submit'])){
    ...
    $quantity;
       ...
       $con=pg_connect("host=localhost dbname=groups user=postgres password=postgres");
        $res=pg_query($con,"select quantity from lube where name='$name0' and size=$size0");
    ...
    if($name0&&$price0&&$size0&&$quantity0){
        pg_query($con,"update lube set quantity=$newquantity where name='$name0' and size=$size0");
