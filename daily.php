...
if(isset($_POST['submit']))
 {
   ...
   // while(1)
   // {
     //  $res=pg_query($con,"select * from m1 where udate='$prevdate'");
      // while($row=pg_fetch_array($res))
         //{
          //if($row[0])
        //    {
...
//break;
  ...
  //  $res=pg_query($con,"select * from m1 where udate='$prevdate' and shift=3");
   // while($row=pg_fetch_array($res))
    //{
 ...
 //   $res=pg_query($con,"select * from m2 where udate='$prevdate' and shift=3");
  //  while($row=pg_fetch_array($res)){
//if($row[0]==$prevdate&&$row[2]==3)
     //   {
        //   $m2out1=$row[3];
   ...
   // $res=pg_query($con,"select * from m3 where udate='$prevdate' and shift=3");
   // while($row=pg_fetch_array($res)){
      //  if($row[0]==$prevdate&&$row[2]==3)
      //   {
      //     $m3out1=$row[3];
...
if (
        $outlet1[0]<$m1out1||$outlet2[0]<$m1out2||$outlet3[0]<$m1out3||$outlet4[0]<$m1out4||
        $outlet1[1]<$m2out1||$outlet2[1]<$m2out2||$outlet3[1]<$m2out3||$outlet4[1]<$m2out4||
        $outlet1[2]<$m3out1||$outlet2[2]<$m3out2||$outlet3[2]<$m3out3||$outlet4[2]<$m3out4
       )
         {
             $check=1;
   ...
   */
...

    {
        ...
        pg_query($con,"insert into m1 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[0]',1,$outlet1[0],$outlet2[0],$outlet3[0],$outlet4[0],$rate[0],$totalsale0,$recieved[0])");
      
        pg_query($con,"insert into m2 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[1]',1,$outlet1[1],$outlet2[1],$outlet3[1],$outlet4[1],$rate[1],$totalsale1,$recieved[1])");

          
        pg_query($con,"insert into m3 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[2]',1,$outlet1[2],$outlet2[2],$outlet3[2],$outlet4[2],$rate[2],$totalsale2,$recieved[2])");

        pg_query($con,"insert into m1 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[3]',2,$outlet1[3],$outlet2[3],$outlet3[3],$outlet4[3],$rate[3],$totalsale3,$recieved[3])");

        pg_query($con,"insert into m2 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[4]',2,$outlet1[4],$outlet2[4],$outlet3[4],$outlet4[4],$rate[4],$totalsale4,$recieved[4])");

        pg_query($con,"insert into m3 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[5]',2,$outlet1[5],$outlet2[5],$outlet3[5],$outlet4[5],$rate[5],$totalsale5,$recieved[5])");

        pg_query($con,"insert into m1 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[6]',3,$outlet1[6],$outlet2[6],$outlet3[6],$outlet4[6],$rate[6],$totalsale6,$recieved[6])");

        pg_query($con,"insert into m2 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[7]',3,$outlet1[7],$outlet2[7],$outlet3[7],$outlet4[7],$rate[7],$totalsale7,$recieved[7])");

        pg_query($con,"insert into m3 (udate,uname,shift,out1,out2,out3,out4,rate,totalsale,recieved) values ('$date','$uname[8]',3,$outlet1[8],$outlet2[8],$outlet3[8],$outlet4[8],$rate[8],$totalsale8,$recieved[8])");

        

//Insertion of remarkss
            if($remarks[0])
            {
                pg_query($con,"update  m1 set remarks='$remarks[0]' where udate='$date' and shift=1");
               // echo 'hi';
            }   
            if($remarks[1])
            {
                pg_query($con,"update  m2 set remarks='$remarks[1]' where udate='$date' and shift=1");
            }
            if($remarks[2])
            {
                pg_query($con,"update  m3 set remarks='$remarks[2]' where udate='$date' and shift=1");
            }
            if($remarks[3])
            {
                pg_query($con,"update  m1 set remarks='$remarks[3]' where udate='$date' and shift=2");
            }
            if($remarks[4])
            {
                pg_query($con,"update  m2 set remarks='$remarks[4]' where udate='$date' and shift=2");
            }
            if($remarks[5])
            {
                pg_query($con,"update  m3 set remarks='$remarks[5]' where udate='$date' and shift=2");
            }
            if($remarks[6])
            {
                pg_query($con,"update  m1 set remarks='$remarks[6]' where udate='$date' and shift=3");
            }
            if($remarks[7])
            {
                pg_query($con,"update  m2 set remarks='$remarks[7]' where udate='$date' and shift=3");
            }
            if($remarks[8])
            {
                pg_query($con,"update  m3 set remarks='$remarks[8]' where udate='$date' and shift=3");
            }
