...
<form action="lubeentry.php" method="POST" class="login">
    <input type="submit" value="Fuel add or remove" style="background: white">
</form>

<form action="lubestockentry.php" method="POST" class="login">
    <input type="submit" value="Fuel Stock Entry" style="background: white">
</form>


<form action="lubesaleentry.php" method="POST" class="login">
    <input type="submit" value="Fuel Sale Entry" style="background: white">
</form>
